...
const PrivacyPolicy = () => (
  <Container>
    <Segment>
      ...
      <p>
        handymanhire ("us", "we", or "our") operates the https://handymanhire.ie
        website (the "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for handymanhire is
      ...
      <p>
        ...
        our Terms and Conditions, accessible from https://handymanhire.ie
      </p>
      ...
      <p>handymanhire uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Ireland and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Ireland and process it there.
      </p>
      <p>
      ...
      <p>
        handymanhire will take all steps reasonably necessary to ensure that
      ...
      <p>
        handymanhire may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of handymanhire</li>
        <li>
