...
const TermsConditions = () => (
  <Container>
    <Segment>
      ...
      <p>Welcome to handymanhire.ie!</p>
      ...
      <p>
        ...
        As a member our community, be responsible in what you post and who you
        choose to work with. Make sure that the information you provide is
        accurate and that the handyman or homeowner you use is legitimate. If
        you find a HandymanHire.ie user that you believe violates these Terms &
        Conditions, please report them through our contact form.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use handymanhire.ie if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing handymanhire.ie, you agreed
        to use cookies in agreement with the HandymanHire's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, HandymanHire and/or its licensors own the
        intellectual property rights for all material on handymanhire.ie. All
        intellectual property rights are reserved. You may access this from
        handymanhire.ie for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from handymanhire.ie</li>
        <li>Sell, rent or sub-license material from handymanhire.ie</li>
        <li>Reproduce, duplicate or copy material from handymanhire.ie</li>
        <li>Redistribute content from handymanhire.ie</li>
      </ul>
      ...
      <p>
        ...
        HandymanHire does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of HandymanHire,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, HandymanHire shall not be
      ...
      <p>
        HandymanHire reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant HandymanHire a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of HandymanHire; and (d) the link
      ...
      <p>
        ...
        e-mail to HandymanHire. Please include your name, your organization
      ...
      <p>
        No use of HandymanHire's logo or other artwork will be allowed for
